...
public class Uva469 {
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		while(t-->0){
			...
			m=new char[105][105];vis=new boolean [105][105];
			int k=0;
			...
			sb.append(floodfill(Integer.parseInt(ns.nextToken())-1,Integer.parseInt(ns.nextToken())-1)+"\n");
			s=bf.readLine();
