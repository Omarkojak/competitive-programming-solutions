...
public class Uva11709_TrustGroups {
	...
	public static void main(String[] args) throws IOException {
		...
		while(!s.equals("0 0")){
			TreeMap<String, Integer>mp=new TreeMap<String, Integer>();int i=0;
			...
			adjList=new ArrayList[V];dfs_num=new int [V];dfs_low=new int [V];inSCC=new boolean[V];stack=new Stack<Integer>();
			counter=0;SCC=0;
			for(int k=0;k<V;k++)
